...
//어노테이션을 통한 빈 등록
//bean 어노테이션: @Controller, @Service, @Repasitory, @Component
//@Controller : controller
//@Service    : service
//@Repasitory : dao
//@Component  : 일반적인 객체
// @Controller, @Service, @Repasitory 어노테이션은 @Component 어노테이션을 기반으로 확장
